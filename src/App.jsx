    ...
    <>
      <main>
        <div className="images">
          <img id="tommoroland" src="/tommoroland.png" alt="" />
          <img id="navy" src="/navy.png" alt="" />
          <img id="msi" src="/msi.png" alt="" />
          <img id="thisPhone" src="/thisPhone.png" alt="" />
          <img id="kikk" src="/kikk.png" alt="" />
          <img id="theCenter" src="/theCenter.png" alt="" />
        ...
        <section id="section-2">
          <div className="titles">
            <div img-title="tommoroland" className="title">
            ...
            <div img-title="thisPhone" className="title">
              <small>2016</small>
            ...
            <div img-title="theCenter" className="title">
              <small>2017</small>
        ...
        <section id="section-4">
          <div className="bottom">
            ...
            <div className="right">
              <p>
                Dogstudio is a design & <br /> technology firm working globally <br /> from
                our offices based in <br /> Belgium and Chicago. <br /> Our strong focus on
                producing <br /> high quality & emotional <br /> brandings, digital products
                and <br /> experiences became a signature.
              </p>
              <p>
                We’re passionate about moving <br /> people and solving problems for <br />
                the likes of Microsoft, The <br /> Museum of Science And Industry <br /> Of
                Chicago, The Kennedy Center <br /> of Washington, Dragone, Quanta <br />
